...
export default function ContactPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      label: "Location",
      value: "Faculty of Technology, Rajarata University, Sri Lanka",
      href: "https://maps.google.com/?q=Faculty+of+Technology,+Rajarata+University+of+Sri+Lanka",
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
